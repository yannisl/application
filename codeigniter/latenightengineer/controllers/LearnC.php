...
function tutorials($location='blog',$title="introduction",$page="1")
{
    ...
    // need to abstract
    $this->_common($location,$title,$page,'cpp_view');
}

function _common($location='blog',$title="introduction",$page="1",$view="cpp_view",$data='')
 {
    // start benchmark
