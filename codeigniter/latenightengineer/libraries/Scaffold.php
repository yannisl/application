...
class Scaffold {
	...
	function __construct($db_table='options2')
	{
		...
		echo $this->base_uri = $this->CI->uri->segment(1).$this->CI->uri->slash_segment(2, 'leading');
	...
	function view()
	{
		...
		echo 'IN VIEW';echo $this->current_table;
		...
		echo 'OFFSET'.$offset;
		echo $this->CI->uri->segment(4,1).'<br />';
		//$offset="options2";
		// Run the query
    ...
    //view data
		...
		$this->CI->load->view('view_table', $data);
	}
	...
	function edit()
	{
	  ...
	  echo 'table name'.$this->current_table;
...
/* Location: ./library/scaffold/Scaffolding.php */