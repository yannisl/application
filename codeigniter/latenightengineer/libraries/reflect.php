<?php
     ...
     *
     * ----------------------------------------------------------------------
     * Modified into a CodeIgniter class by Dr. Y Lazarides
     *
     *                  last revision date 19 June 2009
     *                  version 1.0.0
     * 
     * ----------------------------------------------------------------------
	*/

 define('CACHEFILEPREFIX','reflect_');
 class Reflect{

    //  create a var to hold either $_GET or $_POST
    //  and to hold some default values
    //  for testing or if info is missing

    var $POST=array('cache'=>1,                 // cache=true
                    'tint'=>array(
                            'red=>127',
                            'green=>127',
                            'blue=>127')
    ...
    var $img=array('img'=>'test.png',         // image file name
                   'test'=>'test');
