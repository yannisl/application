...
<img src="http://localhost/egypt/<?php echo $gallery.'/'.$images[rand(0,count($images)-1)]?>" style="width:230px;float:left;margin-right:7px"/>


<p><?php echo anchor(array('options2/', 'view'), '&lt; '.$scaff_view_all); ?></p>
