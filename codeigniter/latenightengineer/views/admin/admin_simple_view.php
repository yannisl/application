...
<body style="
         margin-top:0;background:#ececec">
<!-- Start: Sidcontainer -->
<div class="container clearfix" style="width:1000px">
    ...
    <div id="masthead" style="width:100%;padding-left:0px;margin-left:0px;border-bottom:0px;background:#fff" >
    ...
    <!-- Page Content -->
    <div id="pagecontent" class="clearfix" style="width:970px;padding:15px;margin:0;" >
