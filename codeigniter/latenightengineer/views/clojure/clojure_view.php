...
<script type="text/javascript" src="http://localhost/CodeIgniter/js/jquery.form.js" />-->
        ...
        <script type="text/javaScript" src="http://localhost/CodeIgniter/js/clojure.js"></script>
        <script type="text/javaScript" src="http://localhost/CodeIgniter/js/yl5.js"></script>
...
<!--CSS STYLE FOR DROP-IN REGISTRATION BOX  -->
        <style type="text/css">
...
Thank You!');
            ...
            UI.lostPassword.show=function(){
                $('#lost-password-form').show('medium');
                $('#login-form').hide('medium');
            }
  ...
  <!-- TOP NAVIGATION HIDDEN -->
            ...
            <div class="masthead" style="background:#fff;width:100%;padding-left:0;margin-left:0;border-bottom:0">
                <div class="clearfix" id="pagehead" style="margin-bottom:0;width:95%;margin-top:0px;padding-top:15px">
                    ...
                    clojureNotes<sup style="font-size:12px">&copy;</sup>&nbsp;&nbsp;&nbsp;</span></h1>
                    <ul id="menu" style="background-image:url(/codeigniter/images/icons/assets/nav_bg.gif);">
                        ...
                        <a style="color:#fff" href="/CodeIgniter/LearnPHP/tutorials/php/Introduction">clojureNotes</a></li>
