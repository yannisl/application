...
<link rel="stylesheet" href="http://localhost/egypt/typography.css" type="text/css" />
 <link rel="stylesheet" href="http://www.cuilimg.com/static/v2/css/modern.min.css?1221863107" type="text/css" media="all" />
...
?>  
 ...
 <ul id="LHnav" style="margin-left:0px;width:210px">
			...
			echo '<div style="font-size:smaller;float:right;width:600px;">'.$category.'</div>';
			echo '<div style="clear:both"></div>';
			;
			?>
       <?php echo $content; 
