...
<!-- OBJECT MENU FOR TOOLBAR-->
<style type="text/css">
#toolbar-container{
        border:1px solid red;width:235px;
...
#panelContent{
   width:95%;float:left;border:1px solid purple;
    ...
    <script src="http://localhost/CodeIgniter/js/codemirror/codemirror/mode/stex/stex.js?"></script>
    <script src="http://localhost/CodeIgniter/js/codemirror/codemirror/mode/xml/xml.js?"></script>
    <script src="http://localhost/CodeIgniter/js/codemirror/codemirror/mode/javascript/javascript.js?"></script>
    <script src="http://localhost/CodeIgniter/js/codemirror/codemirror/mode/htmlmixed/htmlmixed.js?"></script>
...
<div id="pagehead" style="width:980px;margin-top:0 ">
    <h1 style="width:56%;margin-top:0;padding:0;padding-left:0;background-image:none">
        <span id="authorImage" style="border-right:0px;padding:0px">
            <img src="http://localhost/CodeIgniter/images/users/robert_DeNiro_2006.jpg"
                 style="height:50px;line-height:1.3;" />
        </span>
...
<form id="mainForm" method="post" action="http://localhost/CodeIgniter/adminSTAMPS/post/save/<?php echo$portal.'/'?><?php echo $location.'/'.$title  ?>" >

   <label>Title</label>
   <input type="text"  value="<?php echo $title ?>" name="title" style="width:98%;margin-bottom:18px;font-family:georgia;font-size:16px" />
   <textarea id="main-edit" class="droppable" name="content"  style="width:500px;height:700px;"><?php echo $content; ?>
  </textarea>
...
<div id="tabs-5" style="font-size:12px">
   ...
   <hr/>
   <textarea id="code3" name="code3" style="font-size:12px;height:900px!important;width:100%}"><?php echo$texcontent;?>
   </textarea>
<!--
 <script>
...
<div id="tabs-6" style="font-size:12px">
   ...
   <span id="saveDocumentSettings" class="bordered" style="cursor:pointer;">Save Document Settings</span></div>
   <hr/>
...
<toolbar id="toolbar-container" class="curvy draggable" style="width:260px;background-color:black">
   <div id="toolbar-head" style="width:250px;margin:0 auto">
           preview | readability | SEO | 
   </div>
  <!-- left moving panel -->
  <div id="panelContainer" style="width:170px">
     <div id="panelContentTitle" style="color:white;background:#000000;
                            text-align:center;width:100%;font-size:12px">
         EDIT POST
     </div>

     <div id='panelContent' class="ON" style="width:150px">
       <div id="postControlPanel" class="clearfix">
         <label style="color:#606060;clear:both"><span style="min-width:16px;min-height:16px"><img src="/CodeIgniter/images/right_arrow.png" /></span> CATEGORIES</label>
            <textarea name="category" rows="100" cols="100" style="width:140px;height:200px;font-family:georgia;font-size:12px;text-indent:0" >
              <?php echo trim($category)?>
           </textarea>
      ...
      <input type="text" value="<?php echo $title ?>" name="save_as" style="width:70%;
      ...
      <input type="submit" value="Save" name="secondary_submit" class="button" id="secondary_submit"/>
        ...
        <div class="curvy" style="border:1px solid #E1E1E1;width:99%">
             ...
             <div class="curvy" style="margin:0 auto;width:90%;height:15px;font-size:12px;
   ...
   <div id="imageToolBox" style="width:80px;background-color:#333;
     ...
     <div style="padding:3px;width:90%;margin:0 auto;border:1px solid">
       <div id="closePanel" style="font-size:10px;border:1px solid silver;text-align:center;width:90%"  onclick="closePanel();return false;">Close</div>
       <div id="openPanel"  style="font-size:10px;border:1px solid silver;text-align:center;width:90%" onclick="openPanel();return false;">Open</div>
     </div>
   </div>
</toolbar>
...
<div class="curvy draggable">testing</div>
...
$(document).ready(function(){
   ...
   $('#savePreamble').click(function(){
       ...
       var url="http://localhost/CodeIgniter/adminSTAMPS/post/savePreamble/<?php echo $location.'/'.$title  ?>";
       $('#mainForm').attr({'action':url})
       $('#mainForm').submit();
   });
   ...
   $('#saveDocumentSettings').click(function(){
       ...
       var url="http://localhost/CodeIgniter/adminSTAMPS/post/saveDocumentSettings/<?php echo $portal.'/'.$location.'/'.$title  ?>";
       $('#mainForm').attr({'action':url})
       $('#mainForm').submit();
   });
