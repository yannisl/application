...
<head> 
<title>Egypt:Stamps and Postal History</title>
...
<?php echo 'Egypt&middot;Philately ';?></span>STAMPS AND POSTAL HISTORY</h1>
</div>
<!-- END NAVIGATION -->
...
//create menu automatically needs to come from model/controller
  ...
  foreach ($list as $key=>$value){
    ...
    $value=str_replace( '/postal_history/', '', $value );
    $this->load->helper('inflector');
    
   echo '<li><a href="'.$value.'">'.humanize($value).'</a></li>';
