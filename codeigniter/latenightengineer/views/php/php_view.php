<?php
//redefine here for ease
//don't change in template
define('LEARN',$learn);
define('ADMINCONTROLLER',$admincontroller)
?>
...
<script type="text/javascript" src="http://localhost/CodeIgniter/js/jquery.form.js" />-->
        ...
        <script type="text/javaScript" src="http://localhost/CodeIgniter/js/PHP.js"></script>
        <script type="text/javaScript" src="http://localhost/CodeIgniter/js/PHPsandbox.js"></script>
        ...
        <div class="container clearfix" style="border-top:3px solid #000000;width:1000px;margin:0 auto">
            ...
            <div class="masthead" style="background:#fff;width:100%;padding-left:0;margin-left:0;border-bottom:0">
                <div class="clearfix" id="pagehead" style="margin-bottom:0;width:95%;margin-top:0px;padding-top:15px">
                   ...
                   <?php echo LEARN ?><sup style="font-size:12px">&copy;</sup>&nbsp;&nbsp;&nbsp;</span></h1>
                    <ul id="menu" style="background-image:url(/codeigniter/images/icons/assets/nav_bg.gif);">
                        ...
                        <a style="color:#fff" href="/CodeIgniter/LearnPHP/tutorials/php/Introduction">php Notes</a></li>
...
<?php if (!isset($feature_image)){echo '';}else{
    ...
    echo '<img  class="rot-ex" id="feature-image" src="'.$feature_image.'" style="margin-left:15px;width:220px" alt="" title="" />';}?>
...
<div contentEditable="true">Try changing...</div>
                    ...
                    <div class="span-17">
                        ...
                        <?php echo '<a href="http://localhost/CodeIgniter/'.$admincontroller.'/post/edit/'.$location.'/'.$title.'">[edit]</a>';?>
                        <?php echo '<a href="http://localhost/CodeIgniter/'.$admincontroller.'/post/new/'.$location.'/'.$title.'">[new]</a>';
                        ?>
                        <?php echo $date ?>
...
-->
                        ...
                        <div style="font-size:10px">
                            <?php echo '<p><a href="http://localhost/CodeIgniter/'.$admincontroller.'/post/edit/'.$location.'/'.$title.'">edit</a></p>';
            ...
            <div style="margin-top:0;padding-left:70px;padding-right:100px;padding-top:30px;padding-bottom:30px;
                ...
                <p style="font-size:11px;width:98%;text-align:center">
                    This site does not claim ownership of any of the pictures displayed.
                    ...
                    Rest of Content &copy; Dr Y.Lazarides +974 (0) 738 -19 15 03 egypt (a) latenightengineer.com
                </p>
