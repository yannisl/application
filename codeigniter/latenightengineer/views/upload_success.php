...
<div id="pagecontent" class="clearfix" >
    ...
    <div class="content-row"  >
        ...
        <div class="span-17">
            ...
            <h3>Your file was successfully uploaded! UPLOAD_SUCCESS</h3>

            <?php if (!isset($upload_data)) $upload=$data;?>

            <p><?php echo anchor('upload', 'Upload Another File!'); ?></p>
            <div>
                <?php echo '<img src="http://localhost/CodeIgniter/uploads/'.$upload_data['raw_name'].$upload_data['file_ext'].'"  id="cropbox" />' ?>

                <h4><?php echo 'uploaded file-name: '.$upload_data['raw_name']  ?></h4>
            ...
            <div>
                <?php echo '<img src="http://localhost/CodeIgniter/uploads/'.$upload_data['raw_name'].'_thumb'.$upload_data['file_ext'].'" />'; ?>
            </div>
            ...
            <form action="crop" method="post" onsubmit="return checkCoords();">
                ...
                <input type="hidden" id="filename" name="raw_name" value="<?Php echo $upload_data['raw_name'] ?>" />
                <input type="hidden" id="file" name="file_ext" value="<?Php echo '.jpg' ?>" />

                <input type="hidden" id="image"  name="image" value=" <?php echo $upload_data['raw_name'].$upload_data['file_ext'] ?>" />
                <input type="submit" value="crop Image" />
            </form>


            <div>
                <?php echo '<img src="./CodeIgniter/uploads/'.'crop_'.$upload_data['raw_name'].$upload_data['file_ext'].'" />' ?>
            </div>
